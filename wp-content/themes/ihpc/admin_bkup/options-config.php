<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'IHPC Options', 'redux-framework-demo' ),
        'page_title'           => __( 'IHPC Options', 'redux-framework-demo' ),
...
*/
   ...
   /* if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
    ...
    $args['footer_text'] = __( '<p>This is theme option panel for all you most of the settings or theme information data manageable from here. (You can take backup using IMPORT/EXPORT section of this panel...Thanks)</p>', 'redux-framework-demo' );
   ...
   /* $tabs = array(
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Home Fields', 'redux-framework-demo' ),
        'id'               => 'basic',
