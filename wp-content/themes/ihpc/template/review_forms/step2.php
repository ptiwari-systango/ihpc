...
<form id="step2" action="" method="post">
    <div class="container">
            ...
            <div class="col-md-6">
                <div class="mood-reasons-list">
                    ...
                    <span id="ComplaintForm_pissedReasonTemp">
                        ...
                        <div class="radio-item">
                            <input type="text" name="ComplaintForm[otherPissedReasonTemp]" class="unhappy-other-reason">
                        </div>
                    </span>               
                </div>
            </div>
            <div class="col-md-6">
                <div class="mood-reasons-list">
                    ...
                    <span id="ComplaintForm_pleasedReasonTemp">
                        ...
                        <div class="radio-item">
                            <input type="text" name="ComplaintForm[otherPleasedReasonTemp]" class="happy-other-reason">
                        </div>
                    </span>                
                </div>
            </div>
        ...
        <div class="row">
            ...
            <a href="<?php echo site_url()."/submit-review?screen_no=3&reviewId=$reviewId" ?>">Skip</a>
        </div>
    </div>
</form>
