        ...
        class ReduxFramework {
            ...
            private function _default_cleanup() {
                ...
                if ( Redux_Helpers::isLocalHost() || ( Redux_Helpers::isWpDebug() ) ) {
                    ...
                    //Make true if you are working on localhost to enable developer mode or wp_debug is true
                    //passed false to disbale developer mode force when WP_DEBUG or site is on Localhost
            ...
            public function _admin_bar_menu() {
                ...
                if ( $menu ) {
                    ...
                    $nodeargs = array(
                        ...
                        'title' => $title,
                        // $theme_data->get( 'Name' ) . " " . __( 'Options', 'redux-framework-ihcp' ),
