 ...
 */
function ihpc_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'ihpc_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.ihpc-front-page) .entry-title,
...
.colors-custom .ihpc-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.ihpc-front-page .panel-content .recent-posts article,
...
.colors-custom.ihpc-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'ihpc_custom_colors_css', $css, $hue, $saturation );
}
